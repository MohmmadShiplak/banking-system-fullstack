...
import { withdrewAmount,findClient,fetchClient } from '../../../features/clientSlice';
import { parse } from 'path';
import { useToast } from '../contexts/ToastContext';

 export default function WithdrewForm () {
...
const withdrewValue =parseFloat(amount)

if(isNaN(withdrewValue)|| withdrewValue <0)
{
...
const result =await dispatch(withdrewAmount({

accountNumber:String(accountNumber),

amount:withdrewValue
...
showToast(
  `Withdrew successfully into account ${accountNumber} with $${withdrewValue.toFixed(2)}. New balance is: $${result.toFixed(2)}`,
  "info"
);
...
console.error("withdrew failed:", error);
...
setAccountNumber(e.target.value)
          ...
          <>
            ...
            <Form.Group className="mb-4" controlId="formAmount">
              <Form.Label className="bank-form-label">Amount to Withdrew</Form.Label>
              <Form.Control
                type="text"
